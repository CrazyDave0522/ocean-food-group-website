...
Defines the brands list feature for the Ocean Food Group website. Provides components and server actions to display a grid of published brands fetched from Supabase. Includes the BrandCard component for individual brand display and BrandsList component with responsive grid layout. Implements responsive design, image handling, error handling, and empty state messaging.
